(() => {
  ...
  var require_frame = __commonJS({
    "frame.js"(exports, module) {
      ...
      var Frame = class {
        ...
        getScore() {
          return reduce(this.scores, (accumulator, pins) => {
  ...
  // bowlingScore.js
  var require_bowlingScore = __commonJS({
    "bowlingScore.js"(exports, module) {
      var { reduce } = require_lodash();
      var Frame = require_frame();
      var BowlingScore = class {
        constructor(frame_class = Frame) {
          this.frames = [];
          this.frame_class = frame_class;
        }
        getTotalScore() {
          return reduce(this.frames, (accumulator, frame) => {
        ...
        applyBonus(pins) {
          let incompleteBonuses = this.frames.filter((frame) => !frame.isBonusComplete());
  ...
  var require_scorecardView = __commonJS({
    "scorecardView.js"(exports, module) {
  ...
  // index.js
  var BowlingModel = require_bowlingScore();
